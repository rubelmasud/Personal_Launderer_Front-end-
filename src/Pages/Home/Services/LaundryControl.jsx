import laundryControlIamge from "../../../assets/Images/total control.png";

const LaundryControl = () => {
  return (
    <div className="md:flex gap-16 pl-12 pr-6 justify-center items-center ">
      <div className="my-6">
        <img
          className="h-[365px] w-full duration-500 transition-transform transform scale-100 hover:scale-110"
          src={laundryControlIamge}
          alt=""
        />
      </div>
